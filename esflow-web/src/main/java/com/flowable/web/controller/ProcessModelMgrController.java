...
public class ProcessModelMgrController{
	...
	public DataGrid processValList(@RequestParam Map<String, Object> params,PageHelper<TaskVariable> page) {
		...
		try {
			...
			if (StringUtils.isBlank(taskId)) {
				...
				grid.setTotal(processTaskValBeans.getTotal());
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public List<Map<String,Object>> processLabel(@RequestParam Map<String, Object> params, HttpServletRequest request, HttpServletResponse response) {
